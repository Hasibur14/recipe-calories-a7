        ...
        <div className='container mx-auto my-16 p-2 lg:p-0'>
            <div
                ...
                <div className="text-white lg:space-y-10 ">
                    <h1 className="text-2xl font-raleway lg:text-7xl font-extrabold">Discover an exceptional cooking <br /> class tailored for you!
                    </h1>
                    ...
                    <div className="lg:flex items-center justify-center lg:space-x-5 ">
                        <button
                            className="btn lg:w-44 lg:h-16 rounded-full bg-[#1DD100] text-white lg:text-xl hover:bg-transparent border-2 border-[#1DD100]">Explore Now</button>
                        <button className='btn lg:w-48 lg:h-16 rounded-full text-white hover:text-green-500 lg:text-xl bg-transparent border-2 '>Our Feedback</button>
                    </div>
                </div>
            </div>
        </div>
