        ...
        <>
            <div className="navbar bg-base-100 container mx-auto mt-10">
                ...
                <div className="navbar-end">
                    <div className='bg-gray-100 hidden lg:flex rounded-full items-center justify-between px-2 '>
                        <img src={search} alt="" />
                        <input className="p-2 rounded-full bg-gray-100 border-none" type="search" name="" id="" placeholder="  Search" />
                    </div>
                </div>
                <div className="bg-green-500 p-2 rounded-full ml-4">
                    <img src={account} alt="" />
                </div>
            </div>
        </>
